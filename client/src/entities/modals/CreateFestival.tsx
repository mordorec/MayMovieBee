...
import {createFestival} from "../../shared/api/movieAPI";
...
const CreateFestival = ({ show, onHide }: ModalProps) => {
    ...
    const addFestival= () => {
        ...
        createFestival(formData).then(() => onHide());
    };
    ...
    return (
        <CreateModal
            title="Добавить новость о фестивале" 
            onHide={onHide} 
            onConfirm={addFestival}
        >
            <input
                value={name}
